...
build({
  entryPoints: ['./src/index.ts', './src/dependencies/index.ts', './src/handlers/index.ts', './src/routes/index.ts','./src/utility/index.ts'],
  outdir: 'dist/src',
  bundle: true,
  platform: 'node',
  // assetNames: 'dist/output/[name].[ext]',
  // resolveExtensions:['.ts','.json'],
  external: ['@aws-sdk/client-kms','prisma','@prisma/client','aws-lambda'], // This ensures aws-sdk is treated as an external dependency
  outExtension: {
    '.js': '.mjs'
  },
